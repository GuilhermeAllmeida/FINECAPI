...
from reserva.views import reserva_criar,index,reserva_listar,reserva_editar,reserva_remover, stand_criar,stand_listar,stand_editar,stand_remover
...
urlpatterns = [
    ...
    path('stand/listar',stand_listar,name='stand_listar'),
]
